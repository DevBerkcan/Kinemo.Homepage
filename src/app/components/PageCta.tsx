  ...
  return (
    <section className="bg-[#08415C] px-6 py-16 text-white md:py-20">
      <div data-motion="reveal" className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_0.8fr_auto] lg:items-end">
        ...
        <Link href={href} data-analytics-event="cta_click" className="group inline-flex min-h-12 w-fit items-center gap-3 border-b border-[#50C9E1] py-2 font-semibold text-[#50C9E1]">
          {label}
